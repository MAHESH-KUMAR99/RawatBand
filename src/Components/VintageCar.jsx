...
// Image imports
import img1 from '../assets/vintage1.jpg';
import img2 from '../assets/vintage2.jpg';
import img3 from '../assets/vintage3.jpg';
import img4 from '../assets/vintage4.jpg';
import img5 from '../assets/vintage5.jpg';
import img6 from '../assets/vintage6.jpg';
...
const whatsapp_url =
  'https://wa.me/919315101006?text=I%20want%20to%20book%20Vintage%20Car';
      ...
      <section className="relative w-full h-[480px] sm:h-[350px] md:h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6">
          ...
          <div className="flex items-center justify-center gap-2 text-white mt-3 sm:mt-4 text-xs sm:text-sm">
            ...
            <ChevronRight />
            <span className="text-[#C9A565]">Vintage Car</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 xl:gap-16">
            ...
            <div className="flex flex-col">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif text-gray-900 mb-3 sm:mb-4">
                Vintage Car Booking – Uttranchal Rawat Band
              </h1>
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-4 sm:mb-6">
                Make your special day unforgettable with a luxurious vintage car
                entry. Royal style for premium weddings and celebrations!
              </p>

              {/* Key Functions */}
              <span className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">
                Key Occasions For Vintage Car Booking:
              </span>
              <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-1 sm:space-y-2">
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Wedding Baraat & Bride-Groom Entry
                </li>
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Reception Arrival
                </li>
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Couple Photoshoot & Anniversaries
                </li>
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Family Joyrides
                </li>
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Film & Special Event Arrivals
                </li>
              </ul>
          ...
          <div className="mt-8 sm:mt-10 lg:mt-12">
            ...
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              ...
              entry, or romantic anniversary celebration. Each car is driven by
              a professional chauffeur, ensuring safety and exceptional service.
              We offer personalized decoration options, custom number plates,
              and photo-friendly arrangements for an elite experience.
              <br />
              <br />
              Whether you want to capture Instagram-worthy moments, make a
              stunning entry, or simply indulge in luxury, our vintage cars are
              the ideal choice for timeless celebrations.
            </p>
          </div>
          ...
          <div className="mt-6 sm:mt-8 lg:mt-10">
            <h1 className="text-xl sm:text-2xl md:text-3xl font-serif text-gray-900 mb-3 sm:mb-5">
              Why Choose Our Vintage Car Services?
            </h1>
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-3 sm:space-y-4">
              <li className="leading-relaxed">
                Premium vintage car models (verified classic brands)
              </li>
              <li className="leading-relaxed">
                Custom flower and ribbon decor as per occasion
              </li>
              <li className="leading-relaxed">Trained, uniformed chauffeurs</li>
              <li className="leading-relaxed">
                Perfect for wedding album & social media posts
              </li>
            </ul>
          </div>
