...
// Image imports
import img1 from '../assets/raj1.jpg';
import img2 from '../assets/raj2.jpg';
import img3 from '../assets/raj3.jpg';
import img4 from '../assets/raj4.jpg';
import img5 from '../assets/raj5.jpg';
import img6 from '../assets/raj6.jpg';
...
const whatsapp_url =
  'https://wa.me/919315101006?text=I%20want%20to%20book%20Rajasthani%20Band';
    ...
    <div>
      ...
      <section className="relative w-full h-[480px] sm:h-[350px] md:h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6">
          <h1 className="shiny-text text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-serif text-white mt-8 sm:mt-12 lg:mt-16 uppercase leading-tight">
            Rajasthani Band
          </h1>
          <p className="text-sm sm:text-base md:text-lg lg:text-xl font-sans text-white mt-2">
            Folk Melodies For Royal Celebrations
          </p>
          <div className="flex items-center justify-center gap-2 text-white mt-3 sm:mt-4 text-xs sm:text-sm">
            ...
            <ChevronRight />
            <span className="text-[#C9A565]">Rajasthani Band</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 xl:gap-16">
            ...
            <div className="flex flex-col">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif text-gray-900 mb-3 sm:mb-4">
                Rajasthani Band Booking – Uttranchal Rawat Band
              </h1>
              ...
              {showPackage && (
                ...
                >
                  <div
                    className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl max-w-sm sm:max-w-lg w-full p-0 relative animate-fadeIn max-h-[90vh] overflow-y-auto"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <button
                      onClick={() => setShowPackage(false)}
                      className="absolute right-3 top-3 sm:right-4 sm:top-4 text-2xl sm:text-3xl text-gray-500 hover:text-[#D33230] transition z-10"
                      title="Close"
                    >
                      &times;
                    </button>
                    <div className="p-5 sm:p-7">
                      <div
                        className="relative flex flex-col items-center min-h-[350px] rounded-2xl sm:rounded-3xl shadow-xl p-4 sm:p-6"
                        style={{
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-4 sm:mb-6">
                Experience the magical charm of Rajasthan at your event with our
                authentic Rajasthani band performances!
              </p>

              {/* Key Functions */}
              <span className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">
                Key Functions Where We Perform:
              </span>
              <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-1 sm:space-y-2">
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Wedding Baraat Entry
                </li>
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Bride-Groom Welcome & Procession
                </li>
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Sangeet & Mehendi Events
                </li>
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Cultural Fests & Corporate Functions
                </li>
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
          ...
          <div className="mt-8 sm:mt-10 lg:mt-12">
            ...
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              Uttranchal Rawat Band brings the soul of Rajasthan to your
              celebrations with our vibrant Rajasthani Band Booking service.
              Enjoy the cultural melodies, royal rhythms, and colorful costumes
              of traditional musicians playing folk instruments like dhol,
              shehnai, nagara, and trumpets. Our band performs energetic folk
              dances and marches, making every wedding baraat, welcome
              procession, and festive event memorable for all guests.
              <br />
              <br />
              Ideal for grand royal entries, wedding sangeet, mehndi, and
              cultural shows, our Rajasthani band infuses unmatched energy,
              crowd interaction, and authentic desert melodies for an
          ...
          <div className="mt-6 sm:mt-8 lg:mt-10">
            <h1 className="text-xl sm:text-2xl md:text-3xl font-serif text-gray-900 mb-3 sm:mb-5">
              Why Choose Uttranchal Rawat Band's Rajasthani Band?
            </h1>
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-3 sm:space-y-4">
              <li className="leading-relaxed">
                Accomplished folk musicians from Rajasthan
              </li>
              <li className="leading-relaxed">
                Vibrant, royal traditional costumes
              </li>
              <li className="leading-relaxed">
                Crowd-engaging folk tunes and dances
              </li>
              <li className="leading-relaxed">
                Flexible acts and musical genres for all events
              </li>
              <li className="leading-relaxed">
                Unforgettable music and festive ambience
              </li>
            </ul>
          </div>
