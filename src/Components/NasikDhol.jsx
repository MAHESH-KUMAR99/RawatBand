...
// Image imports
import img1 from '../assets/Naasik1.jpg';
import img2 from '../assets/Naasik2.jpg';
import img3 from '../assets/Nasik3.jpg';
import img4 from '../assets/Naasik4.jpg';
import img5 from '../assets/Naasik5.jpg';
...
const whatsapp_url =
  'https://wa.me/8285110729?text=I%20want%20to%20book%20Nashik%20Dhol';
...
const packagesData = [
  {
    ...
    intro:
      'Feel the vibrant rhythm of Maharashtras festive beats in a majestic display.',
    bullets: [
    ...
    <div>
      ...
      <section className="relative w-full h-[480px] sm:h-[350px] md:h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6">
          <h1 className="shiny-text text-3xl  sm:text-4xl lg:text-5xl xl:text-6xl font-serif text-white mt-25 sm:mt-12 lg:mt-16 uppercase">
            Nashik Dhol
          </h1>
          <p className="text-sm sm:text-base md:text-lg lg:text-xl font-sans text-white mt-2">
            Thunderous Beats For Grand Celebrations
          </p>
          <div className="flex items-center justify-center gap-2 text-white mt-3 sm:mt-4 text-xs sm:text-sm">
            ...
            <ChevronRight />
            <span className="text-[#C9A565]">Nashik Dhol</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 xl:gap-16">
            ...
            <div className="flex flex-col">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif text-gray-900 mb-3 sm:mb-4">
                Nashik Dhol Taasha Booking – Uttranchal Rawat Band
              </h1>
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-4 sm:mb-6">
                Experience the thunder and energy of authentic Nashik Dhol
                Taasha performances. Perfect for making your wedding or event
                truly grand.
              </p>
          ...
          <div className="mt-8 sm:mt-10 lg:mt-12">
            ...
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              Uttranchal Rawat Band brings the vibrant and powerful spirit of
              Nashik Dhol Taasha to your weddings and celebrations. Originating
              from Maharashtra, this iconic band features large dhols and taasha
              drums played in rhythm, creating an electrifying atmosphere for
              every event. Our professional team, dressed in traditional
              Maharashtrian attire, delivers spectacular high-energy
              performances—ideal for bride-groom entry, baraat, processions,
              corporate events, and festive parades.
              <br />
              <br />
              Whether you want a magnificent baraat, a dramatic groom entry, or
              a show-stopping festival thunder, our Nashik Dhol Taasha group
              guarantees unforgettable memories and crowd engagement.
            </p>
          </div>
          ...
          <div className="mt-6 sm:mt-8 lg:mt-10">
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-3 sm:space-y-4">
              <li className="leading-relaxed">
                Authentic Maharashtra style and rhythm
              </li>
              <li className="leading-relaxed">
                Traditional costumes and stage presence
              </li>
              <li className="leading-relaxed">
                Custom-sized troupe for all event needs
              </li>
              <li className="leading-relaxed">
                Guaranteed drummer energy and crowd entertainment
              </li>
            </ul>
          </div>
