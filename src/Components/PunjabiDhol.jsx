...
// Image imports
import img1 from '../assets/punjabi1.jpg';
import img2 from '../assets/punjabi2.jpg';
import img3 from '../assets/punjabi3.jpg';
import img4 from '../assets/punjabi4.jpg';
import img5 from '../assets/punjabi5.jpg';
import img6 from '../assets/punjabi6.jpg';
import img7 from '../assets/punjabi7.jpg';
...
const whatsapp_url =
  'https://wa.me/8285110729?text=I%20want%20to%20book%20Punjabi%20Dhol';
...
const packagesData = [
  {
    id: 1,
    title: 'Punjabi Dhol Package',
    intro:
      'Rock your event with loud Punjabi beats and vibrant energy that makes every moment unforgettable.',
    bullets: [
      '4 to 8 Professional Punjabi Dhol Players',
      'High-Energy Traditional & Modern Mix',
      'Colorful Branded Uniforms',
      'Perfect for Baraat, Reception & Festivals',
    ],
  },
];
      ...
      <section className="relative w-full h-[480px] sm:h-[350px] md:h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl font-sans text-white mt-2">
            Rock Your Event With Loud Punjabi Beats
          </p>
          <div className="flex items-center justify-center gap-2 text-white mt-3 sm:mt-4 text-xs sm:text-sm">
            ...
            <ChevronRight />
            <span className="text-[#C9A565]">Punjabi Dhol</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 xl:gap-16">
            ...
            <div className="flex flex-col">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif text-gray-900 mb-3 sm:mb-4">
                Punjabi Dhol Booking – Uttranchal Rawat Band
              </h1>
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-4 sm:mb-6">
                Bring home the magic of real Punjabi dhol! Loud, energetic, and
                always entertaining—Uttranchal Rawat Band makes your special day
                unforgettable.
              </p>
          ...
          <div className="mt-8 sm:mt-10 lg:mt-12">
            ...
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              Uttranchal Rawat Band's Punjabi Dhol Booking service brings
              authentic, vibrant Punjabi sound and energy to all your grand
              occasions. Our professional dhol players, dressed in colorful
              branded uniforms, create high-energy musical moments that
              perfectly match the spirit of Indian weddings and festivals. Each
              beat is full of enthusiasm, making baraat processions, receptions,
              birthdays, and corporate events come alive.
              <br />
              <br />
              Our team specializes in crowd engagement, customized rhythms, and
              traditional dhol beats as well as modern fusions—spreading
              happiness & celebration at every step.
            </p>
          </div>
          ...
          <div className="mt-6 sm:mt-8 lg:mt-10">
            <h1 className="text-xl sm:text-2xl md:text-3xl font-serif text-gray-900 mb-3 sm:mb-5">
              Why Choose Uttranchal Rawat Band Punjabi Dhol Team?
            </h1>
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-3 sm:space-y-4">
              <li className="leading-relaxed">
                Modern & traditional fusion performances
              </li>
              <li className="leading-relaxed">Crowd interaction experts</li>
              <li className="leading-relaxed">Flexible event packages</li>
            </ul>
          </div>
