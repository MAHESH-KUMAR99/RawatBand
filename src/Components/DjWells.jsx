...
// Image imports
import img1 from '../assets/dj1.jpg';
import img2 from '../assets/dj2.jpg';
import img3 from '../assets/dj3.jpg';
import img4 from '../assets/dj4.jpg';
import img5 from '../assets/dj5.jpg';
import img6 from '../assets/dj6.jpg';
    ...
    <div>
      ...
      <section className="relative w-full h-[480px] sm:h-[350px] md:h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6">
          <h1 className="shiny-text text-sm sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-serif text-white mt-8 sm:mt-12 lg:mt-16 uppercase leading-tight">
            Dj wells
          </h1>
          ...
          <div className="flex items-center justify-center gap-2 text-white mt-3 sm:mt-4 text-xs sm:text-sm">
            ...
            <ChevronRight />
            <span className="text-[#C9A565]">Dj wells</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 xl:gap-16">
            ...
            <div className="flex flex-col">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif text-gray-900 mb-3 sm:mb-4">
                DJ on Wheels Booking – Uttranchal Rawat Band
              </h1>
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-4 sm:mb-6">
                Make your baraat or wedding party epic with our high-energy DJ
                on Wheels. Experience nonstop music, dance, and fun—anywhere,
                anytime!
              </p>

              {/* Key Functions */}
              <span className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">
                Why Choose Uttranchal Rawat Band DJ on Wheels? Trendsetting
                mobile DJ setups
              </span>
              <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-1 sm:space-y-2">
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Premium sound and light effects
                </li>
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Expert DJs mixing your favorite tracks
                </li>
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Interactive and energetic party experience
                </li>
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Ultra-fast setup and on-the-go mobility
                </li>
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Instagram-worthy dance moments
                </li>
              </ul>
          ...
          <div className="mt-8 sm:mt-10 lg:mt-12">
            ...
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              ...
              weddings—DJ on Wheels. Our fully equipped DJ console with premium
              sound system, disco lighting, colorful LED effects, and expert DJ
              artists turns any baraat or event into a rocking party. Mounted on
              a luxury vehicle or truck, the mobile DJ setup can move with your
              baraat through city streets, wedding lawns, and venues, playing
              Bollywood, Punjabi, EDM, and customized playlists for your
              celebration.
              <br />
              <br />
              Let your entire crew dance non-stop with powerful beats, flexible
              party moves, and interactive crowd engagement. Whether it’s a
              wedding procession, sangeet night, mehendi function, birthday
              bash, or corporate event—our DJ on Wheels guarantees unforgettable
              memories and endless fun.
              <br />
              <br />
              Flawless technical support, power backup, and quick setup ensure a
              hassle-free experience for your big day
            </p>
          </div>
