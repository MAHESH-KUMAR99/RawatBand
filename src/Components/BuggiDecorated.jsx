...
// Image imports
import img1 from '../assets/buggi1.jpg';
import img2 from '../assets/buggi2.jpg';
import img3 from '../assets/buggy3.jpg';
import img4 from '../assets/palki4.jpg';
import img5 from '../assets/palki5.jpg';
import img6 from '../assets/palki6.jpg';
import img7 from '../assets/palki7.jpg';
import img8 from '../assets/palki8.jpg';
...
const whatsapp_url =
  'https://wa.me/919315101006?text=I%20want%20to%20book%20Ghodi%20Baggi';
...
const packagesData = [
  {
    ...
    intro:
      'The traditional and ultimate royal choice for the grooms triumphant entry.',
    bullets: [
      ...
      <section className="relative w-full h-[480px] sm:h-[350px] md:h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl font-sans text-white mt-2">
            Royal Arrival For Your Special Day
          </p>
          <div className="flex items-center justify-center gap-2 text-white mt-3 sm:mt-4 text-xs sm:text-sm">
            ...
            <ChevronRight />
            <span className="text-[#C9A565]">Ghodi Baggi</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 xl:gap-16">
            ...
            <div className="flex flex-col">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif text-gray-900 mb-3 sm:mb-4">
                Baggi Booking – Uttranchal Rawat Band
              </h1>
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-4 sm:mb-6">
                Make your wedding entry majestic and unforgettable with our
                premium decorated baggi service!
              </p>

              {/* Key Functions */}
              <span className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">
                Key Occasions To Book Baggi:
              </span>
          ...
          <div className="mt-8 sm:mt-10 lg:mt-12">
            ...
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              Uttranchal Rawat Band offers luxurious wedding baggi (horse-drawn
              carriage) bookings, giving you a royal entry for your baraat,
              bride/groom arrival, or special anniversary occasion. Each baggi
              is tastefully decorated with flowers, ribbons, and lights to match
              your theme and style. Our experienced coachmen ensure a safe,
              comfortable, and timely experience — perfect for those
              once-in-a-lifetime moments.
              <br />
              <br />
              Whether it's a classy wedding procession, dramatic bride entry, or
              celebratory photo shoot, our baggi service adds a classic touch to
              your event. We prioritize safety, hygiene, and customization for a
              stress-free and memorable ride.
            </p>
          </div>
          ...
          <div className="mt-6 sm:mt-8 lg:mt-10">
            <h1 className="text-xl sm:text-2xl md:text-3xl font-serif text-gray-900 mb-3 sm:mb-5">
              Why Choose Us For Baggi Booking?
            </h1>
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-3 sm:space-y-4">
              <li className="leading-relaxed">
                Premium, well-maintained & decorated baggis
              </li>
              <li className="leading-relaxed">
                Flexible décor options — flowers, ribbons, lights
              </li>
              <li className="leading-relaxed">
                Skilled, uniformed handlers and coachmen
              </li>
              <li className="leading-relaxed">
                Comfortable and safe seating for bride/groom
              </li>
              <li className="leading-relaxed">
                Hygiene and punctuality guaranteed
              </li>
              <li className="leading-relaxed">
                Stunning for wedding albums & social media
              </li>
            </ul>
          </div>
