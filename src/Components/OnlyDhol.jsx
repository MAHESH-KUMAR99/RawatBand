...
// Image imports
import img1 from '../assets/Asmdk.jpg';
import img2 from '../assets/Askjn.jpg';
import img3 from '../assets/oihjdj.jpg';
import img4 from '../assets/mclkflkj.jpg';
import img5 from '../assets/dlkjfkllll.jpg';
import img6 from '../assets/pppdjhgjh.jpg';
import img7 from '../assets/ppdsjdjdj.jpg';
import img8 from '../assets/mmxkjg.jpg';
import img9 from '../assets/cndjjdfhbhj.jpg';
import img10 from '../assets/uubdjsjhjj.jpg';
...
const whatsapp_url =
  'https://wa.me/8285110729?text=I%20want%20to%20book%20Only%20Dhol';
      ...
      <section className="relative w-full h-[480px] sm:h-[350px] md:h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl font-sans text-white mt-2">
            Energize Your Events With Power-Packed Dhol Beats
          </p>
          <div className="flex items-center justify-center gap-2 text-white mt-3 sm:mt-4 text-xs sm:text-sm">
            ...
            <ChevronRight />
            <span className="text-[#C9A565]">Only Dhol</span>
          </div>
      ...
      <div className="min-h-screen bg-white py-8 sm:py-10 md:py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 xl:gap-16">
            ...
            <div className="flex flex-col">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif text-gray-900 mb-3 sm:mb-4">
                Only Dhol Booking – Uttranchal Rawat Band
              </h1>
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-4 sm:mb-6">
                Bring electrifying energy to your events with our professional
                Punjabi dhol team! Perfect for weddings, baraat, parties, and
                all grand celebrations.
              </p>
          ...
          <div className="mt-8 sm:mt-10 lg:mt-12">
            <h1 className="text-xl sm:text-2xl font-serif text-gray-900 mb-3 sm:mb-4">
              Description
            </h1>
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              The Uttranchal Rawat Band specializes in providing authentic
              Punjabi dhol beats that transform every occasion into a
              celebration. Our Only Dhol team brings unparalleled energy and
              rhythmic perfection to weddings, baarats, corporate events,
              inaugurations, and festive gatherings. With vibrant uniforms,
              traditional instruments, and the spirit of celebration, we ensure
              your moments are memorable and joyful.
            </p>
          </div>

          {/* Why Book With Us */}
          <div className="mt-6 sm:mt-8 lg:mt-10">
            <h1 className="text-xl sm:text-2xl font-serif text-gray-900 mb-3 sm:mb-5">
              Why Book With Us?
            </h1>
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-3 sm:space-y-4">
              <li className="leading-relaxed">
                Experienced & passionate dhol artists
              </li>
              <li className="leading-relaxed">
                Customizable packages as per event type
              </li>
              <li className="leading-relaxed">
                Professional uniforms, grand entry performances
              </li>
              <li className="leading-relaxed">
                On-time service, vibrant presence, and crowd interaction
              </li>
            </ul>
          </div>
