...
// Image imports
import img1 from '../assets/doli1.jpg';
import img2 from '../assets/doli2.jpg';
import img3 from '../assets/doli3.jpg';
import img4 from '../assets/doli4.jpg';
import img5 from '../assets/doli5.jpg';
import img6 from '../assets/doli6.jpg';
...
const whatsapp_url =
  'https://wa.me/919315101006?text=I%20want%20to%20book%20Palki%20and%20Doli';
...
const packagesData = [
  {
    ...
    intro: 'Make the brides entry a memorable, elegant, and timeless moment.',
    bullets: [
      ...
      <section className="relative w-full h-[480px] sm:h-[350px] md:h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl font-sans text-white mt-2">
            Royal Bride Entry, Timeless Traditions
          </p>
          <div className="flex items-center justify-center gap-2 text-white mt-3 sm:mt-4 text-xs sm:text-sm">
            ...
            <ChevronRight />
            <span className="text-[#C9A565]">Palki & Doli</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 xl:gap-16">
            ...
            <div className="flex flex-col">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif text-gray-900 mb-3 sm:mb-4">
                Palki & Doli Booking – Uttranchal Rawat Band
              </h1>
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-4 sm:mb-6">
                Celebrate tradition and elegance with our beautiful palki and
                doli bookings for a royal bridal entry.
              </p>

              {/* Key Functions */}
              <span className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">
                Key Occasions To Book Palki & Doli:
              </span>
          ...
          <div className="mt-8 sm:mt-10 lg:mt-12">
            ...
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              Uttranchal Rawat Band offers luxurious palki and doli booking
              services, turning your bridal entry into a timeless royal moment.
              Our collection includes classic and designer palkis & dolis, each
              beautifully decorated in flowers, premium fabrics, and
              eye-catching details—chosen to match your wedding theme and
              vision.
              <br />
              <br />
              Our team ensures every bride is carried with care, comfort, and
              cultural respect, making this touch a highlight of the wedding
              ceremony. We pride ourselves on safe, hygienic, and meticulously
              timed services—giving you peace of mind and perfect wedding
              photographs.
              <br />
              <br />
              Whether you want a traditional Hindu wedding doli or a modern
              designer palki, our decor experts create a magical entrance that
              embraces your dreams and family heritage.
            </p>
          </div>
          ...
          <div className="mt-6 sm:mt-8 lg:mt-10">
            <h1 className="text-xl sm:text-2xl md:text-3xl font-serif text-gray-900 mb-3 sm:mb-5">
              Why Choose Uttranchal Rawat Band Palki & Doli Service?
            </h1>
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-3 sm:space-y-4">
              <li className="leading-relaxed">
                Unique and premium palki/doli designs
              </li>
              <li className="leading-relaxed">
                Custom floral and fabric décor
              </li>
              <li className="leading-relaxed">
                Trained staff for safe comfortable entry
              </li>
              <li className="leading-relaxed">
                Outstanding hygiene and punctuality
              </li>
              <li className="leading-relaxed">
                Dream bride entry, family happiness guaranteed
              </li>
              <li className="leading-relaxed">
                Spectacular for photo albums and videos
              </li>
            </ul>
          </div>
