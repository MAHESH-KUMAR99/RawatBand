...
// Image imports
import img1 from '../assets/chtr1.jpg';
import img2 from '../assets/chtr2.jpg';
import img3 from '../assets/chtr3.jpg';
import img4 from '../assets/chtr4.jpg';
import img5 from '../assets/chtr5.jpg';
import img6 from '../assets/chtr6.jpg';
...
const whatsapp_url =
  'https://wa.me/919315101006?text=I%20want%20to%20book%20Chattar%20Umbrella%20Lights';
...
const packagesData = [
  {
    ...
    intro: 'Add a majestic, royal charm to the grooms baraat procession.',
    bullets: [
...
const Chattar = () => {
  ...
  return (
    <div>
      ...
      <section className="relative w-full h-[480px] sm:h-[350px] md:h-[400px] lg:h-[480px] flex items-center justify-center overflow-hidden">
        <div
        ...
        <div className="relative z-10 text-center px-4 sm:px-6">
          <h1 className="shiny-text text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif text-white mt-8 sm:mt-12 md:mt-16 lg:mt-20 uppercase">
            Chattar
          </h1>
          <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-sans text-white mt-2">
            Brighten Up Your Baraat Entry
          </p>
          <div className="flex items-center justify-center gap-2 text-white mt-3 sm:mt-4 text-xs sm:text-sm">
            ...
            <ChevronRight />
            <span className="text-[#C9A565]">Chattar</span>
          </div>
          <p className="text-xs sm:text-sm md:text-base lg:text-lg font-sans text-white mt-2">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 xl:gap-16">
            ...
            <div className="flex flex-col">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif text-gray-900 mb-3 sm:mb-4">
                Chattar/Umbrella Light Booking – Uttranchal Rawat Band
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 mb-4 sm:mb-6 pb-4 sm:pb-6 border-b border-gray-200">
                <div className="flex gap-1 text-xl sm:text-2xl lg:text-3xl">
                  {[...Array(5)].map((_, i) => (
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-4 sm:mb-6">
                Make your baraat entry shine with our brilliant umbrella light
                (chattar) bookings—perfect for a sparkling wedding procession!
              </p>

              {/* Key Functions */}
              <span className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">
                Key Occasions To Book Chattar/Umbrella Lights:
              </span>
          ...
          <div className="mt-8 sm:mt-10 lg:mt-12">
            ...
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              Uttranchal Rawat Band brings the glow and glamour of designer
              chattar/umbrella lights to your wedding baraat entry. Our
              exclusive umbrella light setups feature beautiful designer
              chattars decorated with flowers, shimmering LEDs or classic bulbs,
              and custom colours to match your wedding theme.
              <br />
              <br />
              Each umbrella light is managed by our trained staff for
              hassle-free setup and procession – ensuring every baraati enjoys
              the festive sparkle, and the bride/groom entry looks dazzling in
              both photos and videos. Our chattar/umbrella lights are ideal for
              night functions, wedding processions, receptions, and anniversary
              celebrations.
              <br />
              <br />
              Safety, hygiene, and visual impact are our priorities—helping you
              create Instagram-worthy wedding memories with every step.
            </p>
          </div>
          ...
          <div className="mt-6 sm:mt-8 lg:mt-10">
            <h1 className="text-xl sm:text-2xl md:text-3xl font-serif text-gray-900 mb-3 sm:mb-5">
              Why Choose Uttranchal Rawat Band Chattar/Umbrella Lights?
            </h1>
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-3 sm:space-y-4">
              <li className="leading-relaxed">
                Premium designer umbrella light chattars
              </li>
              <li className="leading-relaxed">
                Vibrant LED or bulb decorations
              </li>
              <li className="leading-relaxed">
                Customizable colours & flower décor
              </li>
              <li className="leading-relaxed">
                Trained team for safe carrying & setup
              </li>
              <li className="leading-relaxed">
                Unmatched festive ambience for photos & videos
              </li>
              <li className="leading-relaxed">
                Quick, punctual, and professional service
              </li>
            </ul>
          </div>
