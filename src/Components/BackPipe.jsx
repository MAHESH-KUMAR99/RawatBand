...
// Image imports
import img1 from '../assets/back10.jpg';
import img2 from '../assets/back2.jpg';
import img3 from '../assets/back3.jpg';
import img4 from '../assets/back4.jpg';
import img5 from '../assets/back5.jpg';
import img6 from '../assets/back6.jpg';
import img7 from '../assets/back7.jpg';
import img8 from '../assets/back8.jpg';
import img9 from '../assets/back9.jpg';
import img10 from '../assets/back1.jpg';
...
const whatsapp_url =
  'https://wa.me/919315101006?text=I%20want%20to%20book%20Bagpipe%20Band';
...
const packagesData = [
  {
    ...
    title: 'Bagpipe Band',
    intro:
      'A royal touch for your wedding with our disciplined bagpiper tunes and marching band.',
    bullets: [
      '6 to 12 Band Members with Bagpiper',
      ...
      <section className="relative w-full h-[480px] sm:h-[350px] md:h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl font-sans text-white mt-2">
            Royal Tunes For Elegant Celebrations
          </p>
          <div className="flex items-center justify-center gap-2 text-white mt-3 sm:mt-4 text-xs sm:text-sm">
            ...
            <ChevronRight />
            <span className="text-[#C9A565]">Bag Pipe</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 xl:gap-16">
            ...
            <div className="flex flex-col">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif text-gray-900 mb-3 sm:mb-4">
                Bagpipes Band Booking – Uttranchal Rawat Band
              </h1>
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-4 sm:mb-6">
                Give your celebrations a majestic essence with our elegant
                Bagpipes Band. Perfect for royal weddings, spectacular entries,
                and prestigious events.
              </p>

              {/* Key Functions */}
              <span className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">
                Key Occasions We Perform At:
              </span>
              <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-1 sm:space-y-2">
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Wedding Baraat & Reception Entry
                </li>
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
          ...
          <div className="mt-8 sm:mt-10 lg:mt-12">
            ...
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              Uttranchal Rawat Band's Bagpipes Band Booking service brings the
              heritage and grandeur of traditional Scottish bagpipes to your
              celebrations. Our experienced bagpipers, dressed in impressive
              parading uniforms, play ceremonial tunes that create unforgettable
              memories. Whether you wish to make a regal entry at weddings, host
              a prestigious award ceremony, or have a grand reception, our
              Bagpipes Band ensures top-class music and presence.
              <br />
              <br />
              Our versatile musicians can perform traditional Scottish, fusion,
              and popular ceremonial tunes, customized as per your occasion and
              audience — making every moment royal and memorable.
            </p>
          </div>
          ...
          <div className="mt-6 sm:mt-8 lg:mt-10">
            <h1 className="text-xl sm:text-2xl md:text-3xl font-serif text-gray-900 mb-3 sm:mb-5">
              Why Choose Uttranchal Rawat Band Bagpipes Team?
            </h1>
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-3 sm:space-y-4">
              <li className="leading-relaxed">
                Highly skilled bagpipe musicians with years of experience
              </li>
              <li className="leading-relaxed">
                Royal Scottish & military-style uniforms for classic appeal
              </li>
              <li className="leading-relaxed">
                Custom music arrangements for every event type
              </li>
              <li className="leading-relaxed">
                Grand entry and march expertise
              </li>
              <li className="leading-relaxed">
                Memorable performances with attention to detail
              </li>
            </ul>
          </div>
