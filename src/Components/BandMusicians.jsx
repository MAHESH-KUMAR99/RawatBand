...
const whatsapp_url =
  'https://wa.me/8285110729?text=I%20want%20to%20book%20Band%20Musicians';
...
const packagesData = [
  {
    id: 1,
    title: 'Band Musicians Package',
    intro:
      'Give your celebration a majestic melody with professional musicians in exclusive ceremonial uniforms.',
    bullets: [
      '8 to 15 Professional Band Musicians',
      'Complete Brass & Percussion Instruments',
      'Premium Royal Uniforms',
      'Perfect for Baraat, Reception & Grand Entries',
    ],
  },
];
      ...
      <section className="relative w-full h-[480px] sm:h-[350px] md:h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6">
          ...
          <div className="flex items-center justify-center gap-2 text-white mt-3 sm:mt-4 text-xs sm:text-sm">
            ...
            <ChevronRight />
            <span className="text-[#C9A565]">Band Musicians</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 xl:gap-16">
            ...
            <div className="flex flex-col">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif text-gray-900 mb-3 sm:mb-4">
                Band Musicians with Uniforms Booking – Uttranchal Rawat Band
              </h1>
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-4 sm:mb-6">
                Give your celebration a majestic melody with our professional
                band musicians in exclusive ceremonial uniforms.
              </p>

              {/* Key Functions */}
              <span className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">
                Key Functions We Perform At:
              </span>
              <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-1 sm:space-y-2">
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Wedding Baraat Processions
                </li>
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Bride-Groom Grand Entry
                </li>
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Reception Ceremony & Stage Shows
                </li>
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  School/College Annual Parades
                </li>
                <li className="transition-all duration-200 hover:bg-[#FD8F04]/20 hover:text-[#D33230] hover:pl-2 sm:hover:pl-3 rounded cursor-pointer">
                  Corporate & Religious Functions
                </li>
              </ul>
          ...
          <div className="mt-8 sm:mt-10 lg:mt-12">
            ...
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              ...
              clarinets, bugles, and more, expertly played for wedding baraats,
              processions, receptions, and corporate events.
              <br />
              <br />
              From energetic entry march music to soulful wedding welcome tunes,
              our musicians set the perfect tone for every moment. Whether you
              want lively baraat rhythms, classic ceremony pieces, or custom
              playlists curated directly with you, we deliver a memorable
          ...
          <div className="mt-6 sm:mt-8 lg:mt-10">
            <h1 className="text-xl sm:text-2xl md:text-3xl font-serif text-gray-900 mb-3 sm:mb-5">
              Why Book Uttranchal Rawat Band Musicians?
            </h1>
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-3 sm:space-y-4">
              ...
              <li className="leading-relaxed">
                Stylish royal uniforms for classy event look
              </li>
              <li className="leading-relaxed">
                Wide variety of instruments and music genres
              </li>
              <li className="leading-relaxed">
                Custom melody selection as per event
              </li>
              <li className="leading-relaxed">
                Crowd engagement and memorable performances
              </li>
              <li className="leading-relaxed">
                Timely arrival and expert event coordination
              </li>
            </ul>
          </div>
